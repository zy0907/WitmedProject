package com.whackon.witmed.system.dictionary.service;
...
public interface IdentityService {
	 ...
	 * @throws Exception
	 */
	boolean save(IdentityVO saveVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean update(IdentityVO updateVO) throws Exception;
}
